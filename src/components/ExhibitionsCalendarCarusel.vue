<template>
	<div class="exhibitions-calendar calendar">
		<div class="calendar__container">
			<div class="calendar__list">
				<div class="calendar__item animation" v-for="i in 27" :key="i.id">
...
export default {
	...
	setup() {
		...
		onMounted(() => {
			widthItem = document.querySelector('.calendar__item').offsetWidth;
			calendarList = document.querySelector('.calendar__list');
			calendar();
			calendarList.addEventListener('click', clickDate);		
		});

		onUnmounted(() => {
			calendarList.removeEventListener('click', clickDate);
		})
